...
function getBookInfo(){
	...
	xhr.onload = function(){
		...
		//{"room_id":1,"name":"1","price":2,"description":"3","thumbnail_path":"4","default_head":5}
		...
		for(let item of list){
			html += "	<li>";
			html += "		<span>[가]</span> <a href='javascript:void(0)' class='book' data-id='"+ item.room_id +"'>"+item.name+"</a>";
			html += "	</li>";
		}
		html += "</ul>";
		console.log(html);
